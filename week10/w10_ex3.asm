...
main:
move_to_center:
    addi $a0, $zero, 135 # Marsbot rotates 135* and startrunning
    jal ROTATE
    nop
    jal GO
    nop
sleep0: addi $v0,$zero,32 # Keep running by sleeping in 5000 ms
    li $a0,5000 
    syscall
    # Start to draw
    jal TRACK         # draw track line
    nop
    addi $a0, $zero, 60 # Marsbot rotates 60* and startrunning
    jal ROTATE
    nop
    jal GO
    nop
...
sleep2: addi $v0,$zero,32 # Keep running by sleeping in 5000 ms
    ...
    jal TRACK            # and draw new track line
    nop
goLEFT: addi $a0, $zero, 300 # Marsbot rotates 270* 
    jal ROTATE
    nop
