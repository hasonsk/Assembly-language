.data
A: .word  5, -6, 2, -5, 11, -1, 2, -3 
.text
main:       
    la $a0, A   # a0 the base address of this list(A) need to be processed
    li $a1, 8   # a1 the number of elements in list(A) 
    j mspfx     # thá»±c thi tÃ­nh dÃ£y con cÃ³ tá»•ng lá»›n nháº¥t báº¯t Ä‘áº§u tá»« A[0]
    nop 
continue:
lock:  j lock
       nop
