...
set: 	li $t3, 0x01	 # check row 4 with key 0, 1, 2, 3
        li $t4, 0x10 	 # danh dau da duyet het cac hang tron ma tran  
        
polling: 
	 sb $t3, 0($t1)  # must reassign expected row
         lb $a0, 0($t2) # read scan code of key button
 
print: beqz $a0, nextrow # check co phim nao trong ham duoc nhap khong
